...
**2.0.0-rc.4** — Architecture 2.0 prerelease; canonical source: `package.json`. Stable 2.0.0 is not released. Check GitHub Releases for publication and validated product assets; an automatic GitHub source archive is not the ForgeOS product ZIP.
