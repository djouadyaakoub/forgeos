...
test('real discovery result builder detects RC upgrades and never stable-to-RC upgrade',()=>{
  for(const [installed,latest,expected] of [['2.0.0-rc.1','2.0.0-rc.2',true],['2.0.0-rc.1','2.0.0',true],
    ...
    ['2.0.0-rc.3','2.0.0-rc.4',true],['2.0.0-rc.4','2.0.0',true],
    ['2.0.0','2.0.0-rc.4',false],['2.0.0-rc.4','2.0.0-rc.3',false],
...
test('actual activation ordering prerequisite denies downgrades and invalids without activation',()=>{
  assert.equal(evaluateActivationVersionOrder('2.0.0-rc.4','2.0.0-rc.3').reason,'downgrade_not_allowed');
  assert.equal(evaluateActivationVersionOrder('2.0.0','2.0.0-rc.4').reason,'downgrade_not_allowed');
  assert.deepEqual(evaluateActivationVersionOrder('2.0.0-rc.3','2.0.0-rc.4'),{blocked:false,comparison:1});
  assert.deepEqual(evaluateActivationVersionOrder('2.0.0-rc.4','2.0.0'),{blocked:false,comparison:1});
